    ...
    <div class="ms-auto me-auto mb-5 pb-5  d-flex flex-column flex-md-column flex-sm-column flex-lg-row justify-content-center" style="width: fit-content;">
        ...
        <button class="btn btn-light bbt me-4 mb-sm-3 mb-md-3">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 30" style="margin-left:12px; margin-right:12px;height:1.6875em;margin-bottom:12px;">
                <g fill="#212337" stroke="#E8E9EB" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.686">
                    <path d="M1.42 1.85c-.315.314-.42.839-.42 1.469v23.202c0 .63.21 1.155.525 1.47l.104.105 13.009-13.018v-.21L1.42 1.849zm17.519 17.637-4.301-4.304v-.315l4.3-4.305.106.105 5.14 2.94c1.469.84 1.469 2.205 0 3.044l-5.245 2.835h0z"></path>
...
<div class="container ms-auto me-auto mt-3 mb-3" style="width: fit-content;">
    <div class="logo footer-logo">
        <a href="/" style="text-decoration: none;">
            <img class=" img-logo-f1" src="images/logo_logo icon blue copy.png" style="min-width:3.5rem; width:fit-content; max-width:5rem; height:auto;max-height:10rem;" alt="">
            <img class=" img-logo-f2" src="images/logo_text blue only copy.png" style="min-width:6rem; width:fit-content; max-width:10rem; height:auto;max-height:10rem;" alt="">
        </a>
    </div>
</div>
<div class="container ms-auto me-auto mt-3 mb-5 " style="width: fit-content; min-width:'400px'">
    <a href="https://www.instagram.com/moolapay_ng" style="color:black;">

        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="27" fill="currentColor" class="bi bi-instagram me-5" viewBox="0 0 16 16">
    ...
    <a href="https://twitter.com/MoolaPay_ng" style="color:black;">

        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="27" fill="currentColor" class="bi bi-twitter me-5" viewBox="0 0 16 16">
            <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
        </svg>
    </a>
    <a href="https://www.facebook.com/MoolaPayng" style="color:black;">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="27" fill="currentColor" class="bi bi-facebook me-5" viewBox="0 0 16 16">
            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
        </svg>
    </a>
    <a href="https://api.whatsapp.com/send?phone=+2349033796972 " style="color:black;">
